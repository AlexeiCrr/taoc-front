...
declare module '*/paraglide/messages' {
  ...
  export const m: {
    ...
    'quiz.question': (inputs: { number: any }, options?: LocaleOptions) => string;
    ...
    'quiz.greeting.licenseCodePlaceholder': (inputs?: {}, options?: LocaleOptions) => string;
    'quiz.greeting.firstNamePlaceholder': (inputs?: {}, options?: LocaleOptions) => string;
    'quiz.greeting.lastNamePlaceholder': (inputs?: {}, options?: LocaleOptions) => string;
    'quiz.greeting.emailPlaceholder': (inputs?: {}, options?: LocaleOptions) => string;
    'quiz.greeting.agreeToEmail': (inputs?: {}, options?: LocaleOptions) => string;
    'quiz.greeting.startQuiz': (inputs?: {}, options?: LocaleOptions) => string;
    
    // Validation messages
    'quiz.greeting.validation.licenseRequired': (inputs?: {}, options?: LocaleOptions) => string;
    'quiz.greeting.validation.licenseInvalid': (inputs?: {}, options?: LocaleOptions) => string;
    'quiz.greeting.validation.licenseLength': (inputs?: {}, options?: LocaleOptions) => string;
    'quiz.greeting.validation.licenseError': (inputs?: {}, options?: LocaleOptions) => string;
    'quiz.greeting.validation.firstNameRequired': (inputs?: {}, options?: LocaleOptions) => string;
    'quiz.greeting.validation.lastNameRequired': (inputs?: {}, options?: LocaleOptions) => string;
    'quiz.greeting.validation.emailRequired': (inputs?: {}, options?: LocaleOptions) => string;
    'quiz.greeting.validation.emailInvalid': (inputs?: {}, options?: LocaleOptions) => string;
